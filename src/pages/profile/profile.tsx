...
export default function Profile() {
  ...
  React.useEffect(() => {
    const fetchProfile = async () => {
      try {
        const res = await axios.get("/profiles/me"); // 👈 requires JWT in header
        ...
        <CardContent>
          ...
          <Stack spacing={2}>
            ...
            <Autocomplete
              ...
              renderInput={(params) => (
                <TextField {...params} label="Interests" placeholder="Select..." />
              )}
            />
            ...
            <Autocomplete
              ...
              renderInput={(params) => (
                <TextField {...params} label="Allowed Areas" placeholder="Select..." />
              )}
            />
